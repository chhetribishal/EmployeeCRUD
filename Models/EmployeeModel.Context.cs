...
namespace WebAppEmployeOperation.Models
{
    ...
    public partial class EmployeeDBEntities : DbContext
    {
        ...
        public virtual int sp_AddEmployee(string empname, Nullable<decimal> salary)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_AddEmployee", empnameParameter, salaryParameter);
        }
        ...
        public virtual int sp_UpdateEmployee(string empname, Nullable<decimal> salary, Nullable<int> id)
        {
            var empnameParameter = empname != null ?
                new ObjectParameter("empname", empname) :
                new ObjectParameter("empname", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_UpdateEmployee", empnameParameter, salaryParameter, idParameter);
        }
